...
<div id="pageWrap"> 
  ...
  <div id="contentArea">
    <div class="contentDivision"> 
      <p class="breadcrumb"> <!-- InstanceBeginEditable name="breadcrumb" --><a href="http://www.auburn.edu">AU Home</a> &gt; <a href="http://www.auburn.edu/outreach/cgs">Center for Governmental Services</a> &gt; <a href="index.php">BTOP</a> &gt; <a href="BTOP_resources.html">Resources</a> &gt; Video: How to Complete the Monthly Reporting Form <!-- InstanceEndEditable --></p>
      <p class="breadcrumb">&nbsp;</p>
      <!-- InstanceBeginEditable name="body" -->
      <h1><strong>Getting to the Reports Instructions</strong></h1>
      <p>&nbsp;</p>
      ...
      <p>&nbsp;</p>
      <video src="../BTOP/training/monthly_reporting.mp4" height="800px" width="600px" controls="contrtols" autoplay="autoplay"></video>
      </p>
      <p>&nbsp; </p>
      <p><br>
        <br>
      <a href="BTOP_resources.html" style="float:right; font-size:24px">Return</a>   
      </p>
      <h3>&nbsp;</h3>
      <!-- InstanceEndEditable -->
